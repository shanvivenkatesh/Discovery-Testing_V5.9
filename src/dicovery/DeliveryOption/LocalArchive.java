...
public class LocalArchive {
	...
	public void localArchive() throws Exception{
		...
		String deliveryOptionType = sheet.getRow(0).getCell(10).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(10).getStringCellValue();
		String expectedValeStaff = sheet.getRow(2).getCell(10).getStringCellValue();
...
System.out.println(driver.findElementByXPath("(//div[@class='order-option-wrapper'])").getText());
			...
			Assert.assertTrue(Staffcheck.contains("LocalArchive"));
