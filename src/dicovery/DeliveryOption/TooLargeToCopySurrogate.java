...
public class TooLargeToCopySurrogate {
	
		
	@Test
	
	public void tooLargeToCopySurrogate()throws Exception{
...
XSSFWorkbook book = new XSSFWorkbook(src);
		...
		String deliveryOptionType = sheet.getRow(0).getCell(26).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(26).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(26).getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(26).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(26).getStringCellValue();
		...
		driver.findElementByXPath("(//a[@class='discoveryPrimaryCallToActionLink'])[1]").click();
		...
		Assert.assertTrue(Staffcheck.contains("TooLargeToCopySurrogate"));
		...
		Assert.assertTrue(onsitepublic.contains("TooLargeToCopySurrogate"));
       ...
       String deliveryOptionOffsite =driver.findElementByXPath("(//div[@class='order-option-wrapper'])[3]").getText();
		...
		Assert.assertTrue(Offsitecheck.contains("TooLargeToCopySurrogate"));
