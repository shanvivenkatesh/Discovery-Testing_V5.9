...
public class TooLargeToCopyOriginal {
	
	@Test
	
	
	
	public void tooLargeToCopy() throws Exception{
		...
		String deliveryOptionType = sheet.getRow(0).getCell(15)
				.getStringCellValue();
		String iaid = sheet.getRow(1).getCell(15).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(15)
				.getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(15)
				.getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(15)
				.getStringCellValue();
