...
public class MS_ForManorDocuments_KeyWordSearch extends Wrapper_methods {
	...
	@Test
	public void ForMonorDocuments_KeyWordSearch() throws IOException, InterruptedException {
		// launch the browser and url
		launchDriver("http://test.discovery.nationalarchives.gov.uk/manor-search",
				"chrome");
		Thread.sleep(3000);
